...
### [Здесь](https://github.com/slava1005/sys-pattern-homework) находится `fork` [репозитория c шаблоном решения](https://github.com/netology-code/sys-pattern-homework) из инструкции выше. Далее идут шаги выполнения домашнего задания.
